      ...
      this.transactionRecueService.CreateE(this.tr).subscribe(
        res => {
          ...
          if (this.testemp1 != undefined) {
            ...
            this.affectationService.CreateE(this.affectation).subscribe(res => {
          ...
          if (this.testorg1 != undefined) {
            ...
            this.affectation.attribut2 = "غير مستلمة"
            this.affectationService.CreateE(this.affectation).subscribe(res => {
              this.tr.attribut5 = this.affectation.iduserAffected
          ...
          this.liaison.idTrTwo = this.Idtransaction
